        ...
        <div class="flex-1 overflow-y-auto overflow-x-hidden pr-4 content">
          ...
          <div v-if="tabIndex === 5">
            ...
            <div class="flex gap-space">
              ...
              <PopConfirm
                title="Warning: this may break export. Only for 360 Browser on Mac"
                @confirm="disable360"
              >
          ...
          <div v-if="tabIndex === 6">
            <p class="text-red font-bold">Deprecated: this method often fails. Please use the official Supabase sync below.</p>
            <!--          Supabase 设置  -->
