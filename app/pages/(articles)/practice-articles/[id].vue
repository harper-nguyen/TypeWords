        ...
        <div class="bottom">
          <div class="flex justify-between items-center gap-2">
            <div class="stat">
              ...
              <div class="row">
                <!--                <div class="num">{{statStore.spend }}min</div>-->
              ...
              <div class="row">
                <div class="num center gap-1">
                  ...
                  <Tooltip>
                    ...
                    <template #reference>
                      <div>
                        Word count {{ settingStore.ignoreSimpleWord ? 'excludes' : 'includes' }} simple words, excludes mastered
                        <div>Change in Settings → Practice → Simple Word Filter</div>
                      </div>
                    </template>
                  </Tooltip>
                </div>
            ...
            <div class="flex flex-col items-center justify-center gap-1">
              <div class="flex gap-2 center">
                ...
                <BaseIcon
                  :title="`Play sentence (${settingStore.shortcutKeyMap[ShortcutKey.PlayWordPronunciation]})`"
                  @click="play"
                >
                ...
                <BaseIcon
                  ...
                  :title="`Toggle dictation (${settingStore.shortcutKeyMap[ShortcutKey.ToggleDictation]})`"
                >
                ...
                <BaseIcon
                  :title="`Toggle translation (${settingStore.shortcutKeyMap[ShortcutKey.ToggleShowTranslate]})`"
