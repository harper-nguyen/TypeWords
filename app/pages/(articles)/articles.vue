...
useSeoMeta({
  title: `English Article Typing Practice | ${APP_NAME}`,
  description: 'Practice English article typing, sentence listening and keyboard input to improve reading, listening and spelling.',
  ogTitle: `English Article Typing Practice | ${APP_NAME}`,
  ogDescription: 'Improve your English through article typing, listening and keyboard input practice in real contexts.',
  twitterTitle: `English Article Typing Practice | ${APP_NAME}`,
  twitterDescription: 'Improve your English through article typing, listening and keyboard input practice in real contexts.',
})
      ...
      <div class="flex-1">
        ...
        <div class="flex gap-3 mt-3">
          <Progress
            ...
            :format="() => `${base.sbook?.lastLearnIndex || 0}/${base.sbook?.length || 0}`"
            :show-text="true"
          ></Progress>
    ...
    <div class="card flex flex-col">
      <div class="flex justify-between">
        ...
        <div class="flex gap-4 items-center">
          <PopConfirm title="Confirm delete all selected books?" @confirm="handleBatchDel" v-if="selectIds.length">
